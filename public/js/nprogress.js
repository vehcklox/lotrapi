...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nprogress_nprogress_css__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_nprogress__ = __webpack_require__(44);
...
var setupUpdateProgress = function setupUpdateProgress() {
    __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.onDownloadProgress = function (e) {
        var percentage = calculatePercentage(e.loaded, e.total);
        __WEBPACK_IMPORTED_MODULE_1_nprogress___default.a.set(percentage);
    };
};
...
var setupStopProgress = function setupStopProgress() {
    __WEBPACK_IMPORTED_MODULE_2_axios___default.a.interceptors.response.use(function (response) {
        __WEBPACK_IMPORTED_MODULE_1_nprogress___default.a.done(true);
        return response;
    });
};
